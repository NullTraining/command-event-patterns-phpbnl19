...
class SuccessfullTransferTest extends WebTestCase
{
    /** @var Accounts */
    private $accounts;
    ...
    public function testIt(): void
    {
        ...
        $response = $this->doGetRequest('ibanking/transfer/', $params);
        ...
        // Assert to bank account has 107 money on it.
        $this->assertBalanceOnAccount(107, '1000002');
    }
